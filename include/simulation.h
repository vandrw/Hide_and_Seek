...
int makeGame(std::vector<int> &hiderScores, std::vector<int> &seekerScores, std::vector<int> &grid, std::vector<double> rewardsHider, std::vector<double> rewardsSeeker , std::vector<double> rewardsToBase, Agent hider, Agent seeker);
